...
namespace DataAdapter {
    ...
    public partial class BancoDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsuarioRow AddUsuarioRow(int id, string Nome) {
...
namespace DataAdapter.BancoDataSetTableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuario] WHERE (([id] = @Original_id) AND ((@IsNull_Nome = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuario] ([id], [Nome]) VALUES (@id, @Nome);\r\nSELECT id, Nome " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuario] SET [id] = @id, [Nome] = @Nome WHERE (([id] = @Original_id" +
                ") AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)));\r\nSE" +
                "LECT id, Nome FROM Usuario WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataAdapter.Properties.Settings.Default.BancoConnectionString;
        }
        ...
        public virtual int Fill(BancoDataSet.UsuarioDataTable dataTable) {
        ...
        public virtual BancoDataSet.UsuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
